...
#include "ConnectTool/models/chat_model.h"
#include "ConnectTool/models/friends_model.h"
#include "ConnectTool/models/lobbies_model.h"
#include "ConnectTool/models/members_model.h"
#include "platform/audio/sound_notifier.h"
...
private:
  ...
  std::unique_ptr<connecttool::network::TcpTunnelServer> server_;
