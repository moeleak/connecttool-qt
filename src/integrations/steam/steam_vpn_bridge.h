...
#include "network/vpn/heartbeat_manager.h"
#include "network/vpn/ip_negotiator.h"
#include "network/vpn/vpn_protocol.h"
#include "platform/tun/tun_interface.h"
#include <steam_api.h>
#include <atomic>
#include <map>
#include <memory>
...
private:
  ...
  void sendVpnMessage(OutboundMessage message, connecttool::domain::PeerId targetPeerId);
